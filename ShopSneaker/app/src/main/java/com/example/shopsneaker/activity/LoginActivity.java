...
public class LoginActivity extends AppCompatActivity {
    ...
    void Login(String struser, String strpass) {
        ...
        else if (TextUtils.isEmpty(strpass)&&TextUtils.isEmpty(struser)) {
            Toast.makeText(getApplicationContext(), "Nhập đầy đủ thông tin", Toast.LENGTH_LONG).show();
        }
        else {
            strpass = Utils.getMD5(strpass);
            //save data
                    ...
                    .subscribe(
                            userModel -> {
                                if (userModel.isSuccess()) {
                                    ...
                                    String s = "admin";
                                    if (Utils.user_current.getEnabled()==0){
